				      ...
				      +'<div class="box-body">'
				        +'<div class="row margin">'
				          +'<div class="col-sm-12">'
				            ...
				            +'<p><b>Total coupon distribution amount is </b> <span id = "couponDistributionAmount'+mid+'></span></p>'
	...
	var mid = id+'"';	
	  ...
	  var html = '<div class="col-xs-6">'
				      ...
				      +'<div class="box-body">'
				        +'<div class="row margin">'
				          +'<div class="col-sm-12">'
				            +'<p><b>Set voucher amount on registration</b> <input type="number" id = "registration'+mid+'></input><Button style = "height:30px;"class = "btn btn-info pull-right"  id = "registratioDetail'+mid+'>Detail</Button></p>'
