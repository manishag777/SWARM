...
function getRecommendedProductDiv(id){
    ...
    var html = '<div class="col-md-8">'
        ...
        + '<h4>Expected Profit <span class= "pull-right" id = "expectedProfit'+mid+'>Rs. 45000</span></h4>'
        ...
        + '</br>'
        + '<h4>Stall Installation Expenditure<span class= "pull-right" id = "stallInstallmentExpense'+mid+'>Rs. 45000</span></h4>'
...
function getDiscountSchemeDiv(id){
  ...
  var html = '<div class="col-xs-8">'  
		    ...
		    +	   '</br>'
		    +     '<p><span>Recommended discount percent is </span><span id = "bestDiscountPercent'+mid+'>40</span><Button class="btn-info pull-right" style = "width:100px;" id = "setBestDiscountPercent'+mid+'>Set</Button><Button class="btn-info pull-right" style = "width:100px;" id = "bestDiscountPercentDetail'+mid+'>Details</Button></p>'
		    ...
		    +        '<Button style = "margin: auto" onClick = "ApplyDiscountOnSelected()" id = "ApplyDiscountOnSelected'+mid+' class = "btn btn-info">Apply Discounts</Button>&nbsp;&nbsp;'
		    +        '<Button style = "margin: auto" onClick = "generatePamphlet()" id = "GeneratePamphlet'+mid+' class = "btn btn-info">Generate Offers Pamphlet</Button>&nbsp;&nbsp;'
...
function getCouponDiv(id){
	  ...
	  var html = '<div class="col-xs-6">'
				      ...
				      +'<div class="box-body">'
				        +'<div class="row margin">'
				          +'<div class="col-sm-12">'
				          	+ '<p><Button style = "height:30px;"class = "btn btn-info pull-right"  id = "couponCountDetail'+mid+'>Recommendation Details</Button><br/></p>'
				            +'<p><b>Suggested Number of coupon : &nbsp;</b><span id = "expCC'+mid+'>100</span></p>'
				            +'<p><b>Remaining Budget is </b> <span id = "remainingBudgetCoupon'+mid+'></span></p>'
				            +'<p><b>Total coupon distribution amount: </b> <span id = "couponDistributionAmount'+mid+'></span></p>'
				            ...
				            +'<p><b>Suggested Minimum Purchase amount: </b> <span id ="suggestedMinimumPurchaseOnCoupon'+mid+'></span></p>'				            
				            +'<p><b>Set Minimum Purchase amount</b> <input type="text"></input></p>'
				            +'<p><b>Set Coupon Expiry Date</b> <input type="text"  class="date-picker" id = "couponExpiry'+mid+'></input></p><br/>'
				            +'<Button class = "btn btn-info" style = "margin: auto" onClick = "generateAndSaveCoupon()" id = "generateCoupon'+mid+'>Generate and Save Coupon</Button> &nbsp;&nbsp;'
	...
	var mid = id+'"';	
	  ...
	  var html = '<div class="col-xs-6">'
				      ...
				      +'<div class="box-body">'
				        +'<div class="row margin">'
				          +'<div class="col-sm-12">'
				            +'<p><Button style = "height:30px;"class = "btn btn-info pull-right"  id = "registratioDetail'+mid+'>Recommendation Details</Button><br/><br/></p>'
				            +'<p><b>Set voucher amount on registration</b> <input type="number" id = "registrationAmt'+mid+'></input></p>'
				            +'<p style = "color:green">*Make sure resgistration amount is greater than coupon Amount</p>'
				            +'<p><b>Suggested Minimum Purchase amount: </b> <span id ="suggestedMinimumPurchaseOnRegistration'+mid+'></span></p>'				            
				            +'<p><b>Set Minimum Purchase amount</b> <input type="text"></input></p>'
				            +'<p><b>Set Registration Expiry Date</b> <input type="text" class="date-picker" id = "registrationExpiry'+mid+'></input></p><br/>'
				            +'<button class = "btn btn-info" onClick = "generateAndSaveCoupon()">Save Registration Detail</button>&nbsp;&nbsp;'
