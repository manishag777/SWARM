...
public class SpringJdbcDataSource {
	...
	private static final String INSERT_PROFIT_MARKING = "INSERT INTO profit_marking VALUES(?,?,?,?,?)";
	...
	public static void mainNotValid(String[] args) throws IOException {
		...
		List<String> pids = template.queryForList(sql, String.class);
		...
		String sql1 = "select pid from product where sport_id=\'cricket\' and name like \'%Bat%\'";
	...
	private static class Products {
		public Products(int id, int price, Date preDate, int preProfit,
...
*/
	...
	private static void insertOrderDetail(
			List<OrderDto> orderDetailDtoList, int orderId,
