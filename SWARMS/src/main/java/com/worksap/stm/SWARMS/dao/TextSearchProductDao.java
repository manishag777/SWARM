...
public class TextSearchProductDao {
	...
	public List<ProductSearchFetchEntity> searchProductByFilter(
			...
			if(productSearchFilterEntity.getPid()!=null)
			    pid = "%"+productSearchFilterEntity.getPid()+"%";
			
			if(productSearchFilterEntity.getName()!=null)
				brand = "%"+productSearchFilterEntity.getName()+"%";
			
			if(productSearchFilterEntity.getBrand()!=null)
				name = "%"+productSearchFilterEntity.getBrand()+"%";
